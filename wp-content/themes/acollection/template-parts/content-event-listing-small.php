...
<div class="moodboard">
    <div class="moodboard--column">
        <div class="moodboard-group-smaller">
            <a href="<?php the_permalink(); ?>">
                <img src="<?php echo $mood_board[0]['sizes']['wordpress-landscape']; ?>" alt="<?php echo $mood_board[0]['alt']; ?>">
                <span class="hover">
    ...
    <div class="moodboard--column">
        ...
        <div class="moodboard-group-smaller">
            <a href="<?php the_permalink(); ?>">
                <img src="<?php echo $mood_board[3]['sizes']['wordpress-landscape']; ?>" alt="<?php echo $mood_board[3]['alt']; ?>">
                <span class="hover">
                    <span class="hover-content">
                        READ MORE
                    </span>
